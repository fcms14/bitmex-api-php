...
class BitMex {
  ...
  private $API_URL = 'https://www.bitmex.com';
  ...
  public function __construct($apiKey = '', $apiSecret = '', $testnet = "false") {
    ...
    $this->API_URL = $testnet == "false" ? 'https://www.bitmex.com' : 'https://testnet.bitmex.com';
    $this->apiKey = $apiKey;
...
public function getCandles($timeFrame, $startWhen, $endWhen, $offset = 0) {
   ...
   * Cancel An Orders
   *
   * Cancels a selected open order
   *
   * @param $orderID is the order id to cancel
   *
   * @return all closed orders arrays
   */

  public function cancelOpenOrders($orderID) {
